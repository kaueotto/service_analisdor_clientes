...
from entity.dto import dto_modelos,dto_fila
...
class Fila(Base):
    ...
    def new_pedido_fila(cls, cliid, dados,chaveexterna):
        ...
        try:
            ...
            if modelo_instance:
                ...
                QH.inserir_registro(cls,FilaCliId=cliid,FilaChaveExterna=chaveexterna, FilaModId=modelo_dto.ModId, FilaInfoSacado=json.dumps(dados))
    ...
    def buscar_resultado(cls,pedid):
        QH = orm.QueryHelper()
        try:
            pedido_processado = QH.buscar_por_atributo(cls,FilaChaveExterna=pedid)
