...
class dto_cliente:
    ...
    def __str__(self):
        return (f"dto_cliente(CliId={self.CliId}, CliNome='{self.CliNome}', "
    ...
    def to_dict(self):
        return {
            ...
            'CliDataInclusao': self.CliDataInclusao.strftime('%Y-%m-%d %H:%M:%S') if isinstance(self.CliDataInclusao, datetime) else self.CliDataInclusao,
            'CliDataExclusao': self.CliDataExclusao.strftime('%Y-%m-%d %H:%M:%S') if isinstance(self.CliDataExclusao, datetime) else self.CliDataExclusao,
